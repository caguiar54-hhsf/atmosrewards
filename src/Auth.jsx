...
const styles = {
  wrap: {
    ...
    background: "linear-gradient(135deg, #001233 0%, #4a1f7f 55%, #d0248c 100%)",
  ...
  errorMsg: { fontSize: 12.5, color: "#ff8f66", marginTop: 10 },
  switchRow: { fontSize: 12.5, color: "#d3c6ec", marginTop: 16, display: "flex", gap: 6, flexWrap: "wrap" },
  linkBtn: { background: "none", border: "none", color: "#f15fb0", fontSize: 12.5, cursor: "pointer", padding: 0, fontWeight: 600 },
  dot: { color: "#d3c6ec" },
};
